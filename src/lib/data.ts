...
export const pressFeatures = [
  {
    ...
    excerpt: "KILENTAR's debut collection has redefined what it means to dress in darkness — and we're completely obsessed.",
    date: "March 2024",
    logo: "VOGUE",
  },
  {
    ...
    excerpt: "With its commitment to sustainable luxury and avant-garde design, KILENTAR stands apart from the crowd.",
    date: "February 2024",
  ...
  },
  {
    ...
    excerpt: "KILENTAR is leading a new wave of brands that embrace darkness as an aesthetic philosophy.",
    date: "January 2024",
    logo: "BOF",
  },
  {
    ...
    excerpt: "The intersection of architecture and fashion has never been more beautifully realized than in KILENTAR's latest collection.",
    date: "December 2023",
    logo: "WALLPAPER*",
  },
];
